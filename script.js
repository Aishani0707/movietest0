...
async function loadInitialRecommendations() {
  const movies = ['Dark', 'From', '500 days of summer', 'Alice in Borderland', 'The Prestige', 'Oldboy', 'Squid Game' ,'Forrest Gump' ,'Parasite' ,'La la land']; // List of movies to load initially
